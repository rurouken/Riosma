...
<head>
    ...
    <link rel="shortcut icon" type="image/png" href="<?php echo base_url()?>public/Template/assets/images/favicon.png">
    <!-- Place favicon.ico in the root directory -->
    <!-- all css here -->
    <!-- bootstrap v3.3.7 css -->
    <link rel="stylesheet" href="<?php echo base_url()?>public/Template/assets/css/bootstrap.min.css">
    <!-- animate css -->
    <link rel="stylesheet" href="<?php echo base_url()?>public/Template/assets/css/animate.css">
    <!-- owl.carousel.2.0.0-beta.2.4 css -->
    <link rel="stylesheet" href="<?php echo base_url()?>public/Template/assets/css/owl.carousel.min.css">
    <!-- swiper.min.css -->
    <link rel="stylesheet" href="<?php echo base_url()?>public/Template/assets/css/swiper.min.css">
    <!-- font-awesome v4.6.3 css -->
    <link rel="stylesheet" href="<?php echo base_url()?>public/Template/assets/css/font-awesome.min.css">
    <!-- flaticon.css -->
    <link rel="stylesheet" href="<?php echo base_url()?>public/Template/assets/css/flaticon.css">
    <!-- magnific-popup.css -->
    <link rel="stylesheet" href="<?php echo base_url()?>public/Template/assets/css/magnific-popup.css">
    <!-- metisMenu.min.css -->
    <link rel="stylesheet" href="<?php echo base_url()?>public/Template/assets/css/metisMenu.min.css">
    <!-- style css -->
    <link rel="stylesheet" href="<?php echo base_url()?>public/Template/assets/css/styles.css">
    <!-- responsive css -->
    <link rel="stylesheet" href="<?php echo base_url()?>public/Template/assets/css/responsive.css">
    <!-- modernizr css -->
    <script src="<?php echo base_url()?>public/Template/assets/js/vendor/modernizr-2.8.3.min.js"></script>
</head>
...
<body>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-5 col-lg-3 col-sm-4">
                        <div class="logo">
                            <a href="index.html"><img src="<?php echo base_url()?>public/Template/assets/images/logo.png" alt=""></a>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-10 col-sm-9 d-none d-sm-block">
                        <ul class="mainmenu d-flex justify-content-end">
                            ...
                            <li><a href="javascript:void(0);">Quienes Somos</a>
                                <ul>
                            ...
                            <li><a href="blog.html">Intranet</a>
                                <ul>
    ...
    <div class="slider-area">
        <div class="slider-active owl-carousel">
            <div class="slider-items">
                <img src="<?php echo base_url()?>public/Template/assets/images/slider/1.jpg" alt="" class="slider">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="featured-wrap">
                        <div class="featured-img">
                            <img src="<?php echo base_url()?>public/Template/assets/images/featured/1.jpg" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="featured-wrap">
                        <div class="featured-img">
                            <img src="<?php echo base_url()?>public/Template/assets/images/featured/2.jpg" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="featured-wrap">
                        <div class="featured-img">
                            <img src="<?php echo base_url()?>public/Template/assets/images/featured/3.jpg" alt="">
                        </div>
    ...
    <div class="featured-content-area position-relative bg-1">
        ...
        <div class="featured-content-img d-none d-lg-block">
            <img src="<?php echo base_url()?>public/Template/assets/images/about.png" alt="">
        </div>
    </div>
    <!-- about-area end -->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-title text-center">
                        ...
                        <img src="<?php echo base_url()?>public/Template/assets/images/line.png" alt="">
                    </div>
                </div>
            </div>
            <div class="row">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6 d-none d-lg-block">
                    <div class="about-img">
                        <img src="<?php echo base_url()?>public/Template/assets/images/about/1.jpg" alt="">
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-sm-3 col-6">
                            <div class="about-items">
                                <img src="<?php echo base_url()?>public/Template/assets/images/about/icon/1.png" alt="">
                        ...
                        <div class="col-sm-3 col-6">
                            <div class="about-items">
                                <img src="<?php echo base_url()?>public/Template/assets/images/about/icon/2.png" alt="">
                        ...
                        <div class="col-sm-3 col-6">
                            <div class="about-items mb-0">
                                <img src="<?php echo base_url()?>public/Template/assets/images/about/icon/3.png" alt="">
                        ...
                        <div class="col-sm-3 col-6">
                            <div class="about-items mb-0">
                                <img src="<?php echo base_url()?>public/Template/assets/images/about/icon/4.png" alt="">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-lg-3 col-sm-4 col-12">
                            <div class="test-img">
                                <img src="<?php echo base_url()?>public/Template/assets/images/test/1.png" alt="">
                            </div>
                        </div>
    ...
    <div class="expart-area">
        ...
        <div class="expart-img d-none d-lg-block">
            <img src="<?php echo base_url()?>public/Template/assets/images/bg/expart.png" alt="">
        </div>
    </div>
    <!-- expart-area end -->
    ...
    <div class="contact-area">
        ...
        <div class="contact-img d-none d-lg-block">
            <img src="<?php echo base_url()?>public/Template/assets/images/bg/2.jpg" alt="">
        </div>
    </div>
    <!-- contact-area end -->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="team-wrap">
                        <div class="team-img">
                            <img src="<?php echo base_url()?>public/Template/assets/images/team/1.jpg" alt="">
                        </div>
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="team-wrap">
                        <div class="team-img">
                            <img src="<?php echo base_url()?>public/Template/assets/images/team/2.jpg" alt="">
                        </div>
                        <div class="team-content">
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="team-wrap">
                        <div class="team-img">
                            <img src="<?php echo base_url()?>public/Template/assets/images/team/3.jpg" alt="">
                        </div>
                        <div class="team-content">
                ...
                <div class="col-lg-3 col-sm-6 col-12">
                    <div class="team-wrap">
                        <div class="team-img">
                            <img src="<?php echo base_url()?>public/Template/assets/images/team/4.jpg" alt="">
                        </div>
                        <div class="team-content">
            ...
            <div class="row">
                ...
                <div class="col-lg-5 d-none d-lg-block">
                    <div class="nvestments-img">
                        <img src="<?php echo base_url()?>public/Template/assets/images/bg/1.png" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4  col-sm-6 col-12">
                    <div class="blog-wrap">
                        <div class="blog-img">
                            <img src="<?php echo base_url()?>public/Template/assets/images/blog/1.jpg" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-sm-6 col-12">
                    <div class="blog-wrap">
                        <div class="blog-img">
                            <img src="<?php echo base_url()?>public/Template/assets/images/blog/2.jpg" alt="">
                        </div>
                        <div class="blog-content">
